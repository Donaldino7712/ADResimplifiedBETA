...
function getGlyphLevelSources() {
  ...
  const replPow = 0.42 + getAdjustedGlyphEffect("replicationglyphlevel");
...
export function getGlyphLevelInputs() {
  ...
  scaledLevel = instabilitySoftcap(scaledLevel, staticFactors.impossibleInstability, 125);
...
export function staticGlyphWeights() {
  ...
  const impossibleInstability = Glyphs.impossibleInstabilityThreshold;
