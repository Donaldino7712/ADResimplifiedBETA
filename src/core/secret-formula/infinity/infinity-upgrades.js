...
export const infinityUpgrades = {
  ...
  dimboostMult: {
    ...
    effect: () => 3.5,
    formatEffect: value => `${formatX(2.5, 0, 1)} ➜ ${formatX(value, 0, 1)}`,
    charged: {
  ...
  skipResetSacrifice: {
    ...
    description: () =>
      `Start every reset with ${formatInt(5)} Dimension Boosts, automatically unlocking Dimensional Sacrifice;
      and square starting antimatter`,
    effect: 2,
  },
  ipMult: {
    id: "ipMult",
