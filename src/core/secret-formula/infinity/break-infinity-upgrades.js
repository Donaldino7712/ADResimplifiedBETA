...
export const breakInfinityUpgrades = {
  totalAMMult: {
    ...
    effect: () => Math.pow(player.records.totalAntimatter.exponent + 1, 2.2),
  ...
  currentAMMult: {
    ...
    effect: () => Math.pow(Currency.antimatter.exponent + 1, 2),
    formatEffect: value => formatX(value, 2, 2)
  },
  galaxyBoost: {
    id: "postGalaxy",
  ...
  slowestChallengeMult: {
    ...
    effect: () => Decimal.clampMin(Decimal.pow(50 / Time.worstChallenge.totalMinutes, 10), 1),
    formatEffect: value => formatX(value, 2, 2),
    hasCap: true,
    cap: DC.D3E40
  },
