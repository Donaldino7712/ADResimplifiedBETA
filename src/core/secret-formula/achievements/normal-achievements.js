...
export const normalAchievements = [
  {
    ...
    reward: "Convert Antimatter Dimensions to Continuum.",
  },
  {
    id: 12,
    name: "100 antimatter is a lot",
    description: "Have a 2nd Antimatter Dimension.",
    checkRequirement: () => AntimatterDimension(2).continuumAmount > 0,
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimension(3).continuumAmount > 0,
    checkEvent: GAME_EVENT.GAME_TICK_BEFORE,
  },
  {
    id: 14,
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimension(5).continuumAmount > 0,
    checkEvent: GAME_EVENT.GAME_TICK_BEFORE,
  },
  {
    id: 16,
    ...
    checkRequirement: () => AntimatterDimension(6).continuumAmount > 0,
    checkEvent: GAME_EVENT.GAME_TICK_BEFORE,
  },
  {
    id: 17,
    ...
    checkRequirement: () => AntimatterDimension(7).continuumAmount > 0,
    checkEvent: GAME_EVENT.GAME_TICK_BEFORE,
  },
  {
    id: 18,
  ...
  },
  {
    ...
    get description() { return `Have more than ${formatInt(99)} 8th Antimatter Dimensions.`; },
    checkRequirement: () => AntimatterDimension(8).continuumAmount > 99,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    get description() { return `Get over ${formatX(6e3)} from Dimensional Sacrifice outside of Challenge 6.`; },
    checkRequirement: () => !NormalChallenge(6).isOnlyActiveChallenge && Sacrifice.totalBoost.gte(6e3),
  ...
  },
  {
    ...
    checkRequirement: () => InfinityUpgrade.skipResetGalaxy.isUnlocked || AntimatterDimension(8).totalAmount.eq(0),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  ...
  },
  {
    ...
    reward: "Unlock two new Infinity Upgrades."
  },
  {
    id: 42,
    name: "Super Sanic",
  ...
  },
  {
    ...
    get description() { return `Reach ${format(DC.D9E15)} of all Antimatter Dimensions except the 8th.`; },
    checkRequirement: () => AntimatterDimension(7).amount.gt(DC.D9E15),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 47,
  ...
  },
  {
    id: 48,
    name: "Antichallenged",
    get description() { return `Complete all ${formatInt(8)} Normal Challenges.`; },
    checkRequirement: () => NormalChallenges.all.countWhere(c => !c.isCompleted) === 0,
    checkEvent: [GAME_EVENT.BIG_CRUNCH_AFTER, GAME_EVENT.REALITY_RESET_AFTER, GAME_EVENT.REALITY_UPGRADE_TEN_BOUGHT],
    reward: "Infinity Point multiplier equal to unlocked achievement count.",
    effect: () => Math.max(Achievements.effectiveCount, 1),
  ...
  },
  {
    ...
    // The upgradeable autobuyers are dimension boost, galaxy, and big crunch (the ones you get from normal challenges).
  ...
  },
  {
    ...
    get description() {
      return `Complete the 6th Antimatter Dimension Autobuyer Challenge in ${formatInt(3)} minutes or less.`;
    },
    checkRequirement: () => NormalChallenge(6).isOnlyActiveChallenge && Time.thisInfinityRealTime.totalMinutes <= 3,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Dimensional Sacrifice is stronger.
      ${Sacrifice.getSacrificeDescription({ "Achievement32": true, "Achievement57": false, "Achievement88": false })} ➜
  ...
  },
  {
    id: 61,
    name: "Bulked Up",
    description: `Get all of your Antimatter Dimension Autobuyer bulk amounts to $\{"5`,
    checkRequirement: () => true,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
  ...
  },
  {
    ...
    get description() {
      return `Complete the 2nd Antimatter Challenge in ${formatInt(10)} seconds or less.`;
    },
    checkRequirement: () => NormalChallenge(2).isOnlyActiveChallenge && Time.thisInfinityRealTime.totalSeconds <= 10,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  ...
  },
  {
    ...
    get reward() {
      ...
      give ${formatX(1e4)} more Infinities.`;
    },
    effect: 1e4,
    effectCondition: () => Time.thisInfinity.totalSeconds > 2
  },
  {
    id: 88,
  ...
  },
  {
    ...
    get reward() { return `Gain ${formatPercents(0.1)} extra purchases from Continuum.`; },
    effect: 1.1
  },
  {
    id: 97,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    reward: "Square starting Infinity Points.",
    effect: 2,
  },
  {
    id: 114,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    reward: "Multiplier to Dilated Time based on current Time Theorems.",
    effect: () => Math.max(player.timestudy.theorem.ln(), 1),
    formatEffect: value => formatX(value, 2, 2)
  },
  {
    id: 141,
