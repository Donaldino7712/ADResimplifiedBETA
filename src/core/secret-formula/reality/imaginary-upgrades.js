...
export const imaginaryUpgrades = [
  ...
  },
  {
    ...
    id: 20,
    cost: 3e12,
    requirement: () => `Have a Continuum increase from Dark Matter Dimensions of at least ${formatPercents(1)}`,
    hasFailed: () => false,
  ...
  },
  {
    ...
    // Note: 4 cursed glyphs is -12 glyph count, but equipping two positive glyphs in the other slots is allowed
