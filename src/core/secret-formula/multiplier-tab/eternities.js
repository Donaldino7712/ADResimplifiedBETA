...
export const eternities = {
  total: {
    ...
    isActive: () => (PlayerProgress.realityUnlocked() || Achievement(101).isUnlocked) && !Pelle.isDoomed,
    overlay: ["Δ", "<i class='fa-solid fa-arrows-rotate' />"],
  },
  ach101: {
    name: "Achievement 101",
    multValue: () => Achievement(101).effectOrDefault(1),
    isActive: () => Achievement(101).canBeApplied,
