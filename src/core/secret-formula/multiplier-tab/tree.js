...
const propList = {
  AD: ["purchase", "dimboost", "sacrifice", "achievementMult", "achievement", "infinityUpgrade",
    ...
    "alchemy", "pelle", "iap", "effectNC", "nerfIC", "nerfV", "nerfCursed", "nerfPelle", "normalChallenge"],
...
const targetedEffects = {
  achievement: {
    ...
    AD: [12, 18, 23, 28, 31, 34, 48, 56, 64, 65, 68, 72, 73, 74, 76, 84, 91, 92, 183],
    TD: [105, 128],
  ...
  normalChallenge: {
    checkFn: MultiplierTabHelper.NCDimCheck,
    AD: [1]
  },
  infinityChallenge: {
