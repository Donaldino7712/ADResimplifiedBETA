...
export class Galaxy {
  ...
  static get costMult() {
    return Effects.min(NormalChallenge(7).isRunning ? 90 : 60, TimeStudy(42)) +
      InfinityChallenge(5).effects.galaxy.effectOrDefault(0);
  }

  static get baseCost() {
    return NormalChallenge(7).isRunning ? 99 : 80;
  }
  ...
  static get canBeBought() {
    ...
    if (NormalChallenge(6).isRunning || InfinityChallenge(7).isRunning) return false;
